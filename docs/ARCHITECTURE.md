...
1. **Bootstrapper:** Installs from a 50-tool catalog via Winget and npm — 19 always-on core tools (including Claude Code), 15 opt-in power tools (Postman, Terraform, Helm, k9s, DBeaver, MySQL, Ollama, etc.), and 16 language/container/cloud tools, all selected in the interactive wizard except the core set.
